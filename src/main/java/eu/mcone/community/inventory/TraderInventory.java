...
public class TraderInventory extends CoreInventory {
    ...
    public TraderInventory(Player p) {
        ...
        setItem(InventorySlot.ROW_2_SLOT_5, new ItemBuilder(Material.PAPER, 1, 0).displayName(Transl.get("community.traderinventory.entranceticket.display", corePlayer)).lore("§615 " + Transl.get("system.coins.name", corePlayer), "", Transl.get("community.traderinventory.entranceticket.dateofexpiry", corePlayer, 2022)).create(), e -> {
